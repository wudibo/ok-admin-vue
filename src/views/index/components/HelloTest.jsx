...
const HelloTest = defineComponent({
    setup(props, { slots }) {
        ...
        return () => (<div>
                <a-menu openKeys="{options.openKeys}" selectedKeys="{options.selectedKeys}" inline-collapsed="{options.collapsed}" mode="inline" theme="dark">
                    <a-menu-item key="1">
                        <PieChartOutlined />
                        <span>Option 1</span>
                    </a-menu-item>
...
//# sourceMappingURL=HelloTest.jsx.map